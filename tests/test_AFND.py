...
class Testautomato(TestCase):

    def test_create_automato(self):
        """
        ...
        afnd.add_all_states(['q0', 'q1', 'q2', 'q3'])
        afnd.add_initial_state('q0')
        afnd.final_state(['q3'])

        self.assertEqual(['0', '1'], afnd.alphabet, "Alphabet ok")
        self.assertEqual(['q0', 'q1', 'q2', 'q3'], afnd.states, "states ok")
        self.assertEqual('q0', afnd.initial_state, "initial state ok")
